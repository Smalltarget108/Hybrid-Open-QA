...
for ckpt_path, config_name in table_with_sql:
    ...
    estimator = PyTorch(debugger_hook_config=False, # IMPORTANT: sagemaker debugger is CANCER!!!!!
                        ...
                        output_path='s3://hanboli-research/hybridQA/sm_inference_output',
                        code_location='s3://hanboli-research/hybridQA/sm_inference_output',
    ...
    input_dict = {
        'train': 's3://hanboli-research/FID-inference',
        'test': 's3://hanboli-research/hybridQA/sm_output/' + ckpt_path + '/output',
    }
